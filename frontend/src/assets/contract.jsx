...
function Contact() {
  // After your Express changes, the contact endpoints are namespaced under /api/contacts
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setSubmitMessage(`${emailSent ? '✓' : '✗'} ${result.message || 'Contact submitted successfully!'}${emailDetails}`);
